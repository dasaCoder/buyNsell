...
var RegisterPage = /** @class */ (function () {
    function RegisterPage(afr, rout) {
        this.afr = afr;
        this.rout = rout;
    }
    RegisterPage.prototype.register = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, cpassword, res;
            return __generator(this, function (_b) {
                _a = this, email = _a.email, password = _a.password, cpassword = _a.cpassword;
                if (password !== cpassword) {
                    return [2 /*return*/, console.error('las contraseñas no son iguales')];
                }
                try {
                    res = this.afr.auth.createUserWithEmailAndPassword(email, password);
                    console.log(res);
    ...
    RegisterPage.prototype.registerGmail = function () {
        return __awaiter(this, void 0, void 0, function () {
            var res, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.afr.auth.signInWithPopup(new firebase_app__WEBPACK_IMPORTED_MODULE_2__["auth"].GoogleAuthProvider())];
                    case 1:
                        res = _a.sent();
                        console.log(res);
                        this.rout.navigateByUrl('/login');
